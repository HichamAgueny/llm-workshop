#!/bin/bash -e
#SBATCH --job-name=Xsum_Inference_llama3_1B
...
# Xsum
CONFIG_FILE="${CONFIG_DIR}/llama_3.2_1B_generation_Xsum.yaml"

PYTHON_FILE="${PYTHON_DIR}/generate.py"

# Define the output & logging directories for fine-tuning results
OUTPUT_DIR="$MyWD/data/Inference_results/Llama-3.2-1B-Instruct_inference_Xsum_out"
