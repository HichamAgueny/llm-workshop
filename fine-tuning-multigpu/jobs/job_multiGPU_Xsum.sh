#!/bin/bash -e
#SBATCH --job-name=XsumFineTune_llama3_1B_4GPU
...
OUTPUT_DIR="$MyWD/data/Llama-3.2-1B-Instruct_Xsum_out_multiGPU"
LOGGING_DIR="$MyWD/data/lora_finetune_Xsum_output_multiGPU"
