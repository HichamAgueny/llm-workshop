...
1. **Explore the SLURM job script**  
   - Navigate to the `jobs/` directory:
     ```bash
     cd /cluster/work/projects/nn9970k/$USER/llm-workshop/fine-tuning-singlegpu/jobs
     ````
...
2. **Check the configuration file**  
   - Go to the `config/` directory:
     ```bash
      cd /cluster/work/projects/nn9970k/$USER/llm-workshop/fine-tuning-singlegpu/config_scripts
     ````
...
* The slurm output file is saved in:
  ...
  ```
  /cluster/work/projects/nn9970k/$USER/llm-workshop/fine-tuning-singlegpu/jobs/out
  ```
...
```bash
   /cluster/work/projects/nn9970k/$USER/llm-workshop/data/Llama-3.2-1B-Instruct_out_onlyLoRAweight
````
