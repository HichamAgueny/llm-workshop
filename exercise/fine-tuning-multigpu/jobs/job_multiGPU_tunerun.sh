#!/bin/bash -e
#SBATCH --job-name=1FineTune_llama3_11B_4GPU_tunerun
#SBATCH --account=nn9997k
#SBATCH --time=2-16:35:00
...
OUTPUT_DIR="$MyWD/data/Llama-3.2-11B-Vision-Instruct_out_multiGPU_tunerun"
LOGGING_DIR="$MyWD/data/lora_finetune_11B_output_multiGPU_tunerun"
