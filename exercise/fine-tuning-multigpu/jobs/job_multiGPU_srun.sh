#!/bin/bash -e
#SBATCH --job-name=1FineTune_llama3_11B_4GPU_srun
...
OUTPUT_DIR="$MyWD/data/Llama-3.2-11B-Vision-Instruct_out_multiGPU_srun"
LOGGING_DIR="$MyWD/data/lora_finetune_11B_output_multiGPU_srun"
